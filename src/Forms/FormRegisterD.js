        ...
        <div className="container">
            <Form onSubmit={handleSubmit}>
                ...
                <Form.Group className="mb-3" controlId="formGridAddress2">
                    ...
                    <Form.Control type="password" placeholder="CUIT" value={datos.cuit} onChange={(e => setCuit(e.target.value))} />
                </Form.Group>

                <Form.Group className="mb-3" controlId="formGridAddress2">
                    <Form.Label className="fs-4 text-white"><b>CODIGO de la EMPRESA u ORGANIZACIÓN</b></Form.Label>
                    <Form.Control type="password" placeholder="Codigo" value={datos.codigoEmpresa} onChange={(e => setCodigoEmpresa(e.target.value))} />
                </Form.Group>
